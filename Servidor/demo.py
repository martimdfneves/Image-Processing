...
def calculate_attention(ids, key, eulerAngles, crop):
	...
	if stat is not None:
		...
		agent = Agent.objects.get(pk = crop.agentid)
		stat = Stats(person=person,content=doc,agent=agent,attention=current_attention)
	stat.save()
...
def save_data(ids):
	...
	with open('/home/martim/Desktop/PEI/stats.json', 'w') as file:
...
def main():
	...
	predictor = dlib.shape_predictor('/home/martim/Desktop/PEI/shape_predictor_68_face_landmarks.dat')
	# CUDA is required to use this model for face recognition
	facerec = dlib.face_recognition_model_v1("/home/martim/Desktop/PEI/dlib_face_recognition_resnet_model_v1.dat")
	...
	sess = rt.InferenceSession('/home/martim/Desktop/PEI/emotions.onnx')
	...
	print("acabou dicionario")

	while True:
		dir = "/home/martim/Desktop/PEI/peidashboard/media_cdn/"
		crops = Crop.objects.all()
		print("sacar crops")
		for crop in crops:
			print("cada crop")
			if crop.cropfile != "":
				print("crop nao vazio")
				print(crop.cropfile)
				frame = cv2.imread("/home/martim/Desktop/PEI/peidashboard/media_cdn/%s" %crop.cropfile) 
